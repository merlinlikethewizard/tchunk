...
execute as @e[name="turtlechunkmarker"] at @s unless block ~ ~ ~ #computercraft:turtle run function _tchunk:findturtle

# Look for adjacent, unmarked turtles, and mark them
execute as @e[name="turtlechunkmarker"] at @s if block ~ ~ ~ #computercraft:turtle run function _tchunk:findnew

# Make a particle indicator
# execute as @e[name="turtlechunkmarker"] at @s positioned ~0.5 ~1.2 ~0.5 run particle composter ~ ~ ~ 0 0 0 0 1
...
execute as @e[name="turtlechunkmarker"] at @s run forceload add ~ ~